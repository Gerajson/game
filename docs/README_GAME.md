...
## Browser V2 (проверка без Cocos)

Если нужно проверить механику без Cocos Creator, используйте `web-v2/index.html`.
Подробный запуск через VS Code описан в `web-v2/README.md`.
